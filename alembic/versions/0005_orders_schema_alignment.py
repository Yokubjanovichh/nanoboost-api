...
def upgrade() -> None:
    ...
    op.alter_column("order_items", "price_usd_at_order", new_column_name="unit_price_usd")
    op.alter_column("order_items", "price_eur_at_order", new_column_name="unit_price_eur")
    op.alter_column("order_items", "line_total_usd", new_column_name="total_price_usd")
...
def downgrade() -> None:
    ...
    op.drop_constraint("fk_order_items_option_id", "order_items", type_="foreignkey")
    op.drop_column("order_items", "option_id")
    op.drop_column("order_items", "total_price_eur")

    op.alter_column("order_items", "total_price_usd", new_column_name="line_total_usd")
    op.alter_column("order_items", "unit_price_eur", new_column_name="price_eur_at_order")
    op.alter_column("order_items", "unit_price_usd", new_column_name="price_usd_at_order")
